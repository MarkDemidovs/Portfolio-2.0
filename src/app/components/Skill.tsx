...
export default function Skill({ title, items }: SkillProps) {
  return (
    <div className="bg-foreground rounded-2xl max-sm:max-w-36 max-sm:min-w-16 max-md:max-w-60 max-md:min-w-60 md:max-w-96 md:min-w-96 md:h-96 mt-7 max-md:ml-2 md:ml-10 sm:p-1 md:p-2 lg:p-4 flex flex-col">
